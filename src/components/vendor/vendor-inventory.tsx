    ...
    <div className="space-y-4">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="h-auto flex-wrap gap-1 bg-muted/50 p-1">
          <TabsTrigger value="garment" className="text-xs">Garment Inventory</TabsTrigger>
          <TabsTrigger value="reports" className="text-xs">Damage & Missing Reports</TabsTrigger>
        </TabsList>
